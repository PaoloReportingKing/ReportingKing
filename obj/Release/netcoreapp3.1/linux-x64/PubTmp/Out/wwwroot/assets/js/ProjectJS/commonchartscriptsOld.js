var pallet1 = ['#A50044', '#004D98', '#EDBB00', '#e6d600', '#ff1a79', '#1a8cff', '#e6b400', '#b3a700', '#ff80b5', '#4da3ff', '#b38900', '#e6d200'];//needs to change in view
var pallet2 = ['#A800FF', '#0079FF', '#00F11D', '#e6d600', '#d580ff', '#3392ff', '#00cc18', '#ccbe00', '#df99ff', '#66a8ff', '#00cc11', '#e6d200'];
var pallet3 = ['#010101', '#4BE1EC', '#F53C3C', '#377280', '#666666', '#16c3d0', '#f76e6e', '#70b1c2', '#1297a1', '#15c4d1', '#fb9d9d', '#84bbc8'];
var pallet4 = ['#510C6C', '#E74164', '#F7CC3D', '#38C8A7', '#9b17cf', '#dcab09', '#ee7791', '#37c8a6', '#d88ef0', '#f3a5b8', '#dcaf09', '#239073'];
var pallet5 = ['#F79400', '#136BAE', '#000000', '#4C6887', '#ffc266', '#47a4eb', '#666666', '#6c8aac', '#ffb84d', '#125887', '#bfbfbf', '#9db1c8'];
var pallet6 = ['#097275', '#ee6055', '#dfbf6d', '#C96C1C', '#0eb8be', '#f6a8a2', '#dbb857', '#e7944b', '#5be9f1', ' #fad3d1', '#685418', '#703d0f'];
var pallet7 = ['#DE3036', '#0061CB', '#EDAA02', '#82B216', '#ed9194', '#4da3ff', '#fcbc1d', '#a7e31c', '#e77e83', '#4da0ff', '#805b00', '#53700f'];
var pallet8 = ['#EB4E21', '#01A4EF', '#80BB01', '#FFB901', '#f4a18a', '#67cefe', '#577f01', '#ffb700', '#f38872', '#004666', '#456501', '#805b00'];
var pallet9 = ['#383be0', '#0F8567', '#13A0F0', '#05ada2', '#2023c5', '#17cfa1', '#27a7f1', '#047c74', '#6868e3', '#0d7359', '#107dbc', '#057a76'];
...
var palleteArray = [
    ...
    ['#A50044', '#004D98', '#EDBB00', '#e6d600', '#ff1a79', '#1a8cff', '#e6b400', '#b3a700', '#ff80b5', '#4da3ff', '#b38900', '#e6d200'],
    ['#A800FF', '#0079FF', '#00F11D', '#e6d600', '#d580ff', '#3392ff', '#00cc18', '#ccbe00', '#df99ff', '#66a8ff', '#00cc11', '#e6d200'],
    ['#010101', '#4BE1EC', '#F53C3C', '#377280', '#666666', '#16c3d0', '#f76e6e', '#70b1c2', '#1297a1', '#15c4d1', '#fb9d9d', '#84bbc8'],
    ['#510C6C', '#E74164', '#F7CC3D', '#38C8A7', '#9b17cf', '#dcab09', '#ee7791', '#37c8a6', '#d88ef0', '#f3a5b8', '#dcaf09', '#239073'],
    ...
    ['#DE3036', '#0061CB', '#EDAA02', '#82B216', '#ed9194', '#4da3ff', '#fcbc1d', '#a7e31c', '#e77e83', '#4da0ff', '#805b00', '#53700f'],
    ['#EB4E21', '#01A4EF', '#80BB01', '#FFB901', '#f4a18a', '#67cefe', '#577f01', '#ffb700', '#f38872', '#004666', '#456501', '#805b00'],
    ['#383be0', '#0F8567', '#13A0F0', '#05ada2', '#2023c5', '#17cfa1', '#27a7f1', '#047c74', '#6868e3', '#0d7359', '#107dbc', '#057a76']
];
...
function bindScroller(chartid, allow) {
    if (allow) {
