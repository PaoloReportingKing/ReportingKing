                ...
                value: function () {
                    ...
                    return new Promise((function (e) {
                        ...
                        if (window.canvg && g.isIE11()) {
                            ...
                            if (n.indexOf(`font-size="12px"`) > -1) {
                                n = n.replaceAll(`font-size="12px"`, `font-size="16px"`)
                            }

                            if (n.indexOf(`font-size="11px"`) > -1) {
                                n = n.replaceAll(`font-size="11px"`, `font-size="14px"`)
                                n = n.replaceAll(`font-weight="400"`, `font-weight="600"`)
                            }

                            if (n.indexOf(`stroke="#b6b6b6"`) > -1) {
                                n = n.replaceAll(`stroke="#b6b6b6"`, ``)
                            }
