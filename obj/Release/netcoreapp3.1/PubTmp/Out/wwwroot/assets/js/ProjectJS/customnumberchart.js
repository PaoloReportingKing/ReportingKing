...
function getnumberchartdivs(chartconfigobj, addmargin) {
    ...
    if (chartconfigobj.chartYAxises.length > 0) {
        ...
        var legenddiv = `<div id="legenddiv${chartid}" class="row" style="margin-top:9px"><div class="col-md-12 justify-content-center align-items-center d-flex">
                                        <a onclick="removeyaxis('','${chartid}')" style="color: white;height: 15px;width: 15px;background-color: ${colour};border-radius: 50%;display: inline-flex;cursor: pointer;align-items: center;justify-content: center;"></a>
