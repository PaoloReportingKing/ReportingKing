    ...
    if (chartconfigobj != undefined) {
        ...
        $.each(chartconfigobj.chartYAxises, function (s, catfield) {
            ...
            if (chartconfigobj.chartXAxisLabels.length > 0) {
                ...
                //   debugger;
                //.filter(element => element[chartconfigobj.chartXAxis] == xaxis);
                var sumvalue = 0;
            ...
            seriesyaxisobj.maximumyaxis = maximummargin;
            //  debugger;
            if (maximummargin > 0) {
        ...
        var options = {
            ...
            legend: {
                ...
                formatter: function (seriesName, opts) {
                    ...
                    if (notmojuud) {
                        return [" <div class='spantotal' style='text-align:center ;" + showtotal + "'> " + ApplyFormatting(total, seriesName) + "</div><strong style='padding-bottom:2px;border-radius:3px;padding-left:3px;padding-right:3px;color:white;background-color:red'>" + seriesName + "</strong>"];
                    }
                    else {
